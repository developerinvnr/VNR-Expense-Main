		...
		<div class="col-md-12 h-100 " style="padding:0px;">
			...
			<table class="table shadow" style="width:100%;" align="center">
			  ...
			  <tbody>
				...
				$cl=mysql_query("SELECT * FROM `y".$_SESSION['FYearId']."_expenseclaims`  WHERE `ClaimYearId`='".$_SESSION['FYearId']."' and `CrBy`='".$crby."' and ExpId!='".$_REQUEST['expid']."' and (ClaimStatus='Submitted' OR ClaimStatus='Draft') AND ClaimStatus!='Deactivate' order by ExpId"); //AttachTo=0
