		...
		<div class="col-md-4 table-responsive">
			...
			<table class="table table-sm shadow minpadtable">
			  ...
			  if($_SESSION['EmpRole']=='E' || $_SESSION['EmpRole']=='A'){
			      ...
			      $seluq=mysql_query("SELECT * FROM hrm_employee where EmployeeID=".$_SESSION['EmployeeID'],$con2);
			      
			  	//$table=dbemp.".`hrm_employee`";
			  }else{
			  	//$table='`hrm_user`';
			  	$seluq=mysql_query("SELECT * FROM hrm_user where EmployeeID=".$_SESSION['EmployeeID'],$con);
			  }
