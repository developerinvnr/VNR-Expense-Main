...
<?php 
  ...
  $sql_statement=mysql_query("SELECT * FROM `y".$_SESSION['FYearId']."_monthexpensefinal` WHERE YearId=".$_SESSION['FYearId']." and `Status`='Closed' and Total_Claim>0 and Finance_Amount>0 and Finance_Date!='0000-00-00' and Fin_AppBy>0 and Fin_AppDate!='0000-00-00' and Fin_AppDate!='' and Fin_AppDate!='1970-01-01' and Fin_PayAmt='' and Fin_PayOption='' and Fin_PayBy=0 and ".$cond." order by Month asc, EmployeeID asc");			
...
$from = 0;
  ...
  $m=mysql_query("SELECT * FROM `y".$_SESSION['FYearId']."_monthexpensefinal` WHERE YearId=".$_SESSION['FYearId']." and `Status`='Closed' and Total_Claim>0 and Finance_Amount>0 and Finance_Date!='0000-00-00' and Fin_AppBy>0 and Fin_AppDate!='0000-00-00' and Fin_AppDate!='' and Fin_AppDate!='1970-01-01' and Fin_PayAmt='' and Fin_PayOption='' and Fin_PayBy=0 and ".$cond." order by Month asc, EmployeeID asc LIMIT ".$from.",".$offset);
  $i=1; 
  ...
  <form action="" class="form-horizontal"  role="form">
   <tr>
	...
	<td>
	 ...
	 <td style="text-align:right;"><b><?=$mlist['Finance_Amount'];?></b>&nbsp;
	 <input type="hidden" id="FinnAmt<?=$i?>" name="FinnAmt<?=$i?>" value="<?=$mlist['Finance_Amount'];?>" />
	 </td>
...
?>
 ...
 <tr>
  ...
  <td style="text-align:right;"><b><?=$mlist['Finance_Amount'];?></b>&nbsp;</td>
