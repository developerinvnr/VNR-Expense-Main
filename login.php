...
$con2=mysql_connect('localhost','hrims_user','hrims@192') or die(mysql_error());
//$con2=mysql_connect('localhost','root','ajaydbajay') or die(mysql_error());
$empdb=mysql_select_db('hrims', $con2) or die(mysql_error());
...
else
{
 ...
 if($FirstLet=='T'){ $DbName='expense_tl'; $ComID=4; }
 elseif($FirstLet=='N'){ $DbName='expense_nr'; $ComID=3; }
 else{ $DbName='expense'; $ComID=1; }
  
 $con=mysql_connect('localhost','expense_user','expense@192',true) or die(mysql_error());
