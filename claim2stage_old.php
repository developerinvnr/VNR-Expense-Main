...
function ExpRep(v)
{ 
  window.open("PayStsExp.php?act=Stageexportdetails&v="+v,"QForm","menubar=no,scrollbars=yes,resizable=no,directories=no,width=50,height=50");
}
...
?>
  <form action="" class="form-horizontal"  role="form">
   <tr>
	<td colspan="10">
	 <span style="font-size:20px;color:#000099;cursor:pointer; font-family:'Times New Roman', Times, serif;" onclick="ExpRep(<?=$_REQUEST['v']?>)"><u>Export</u></span>
	</td>
   </tr>
