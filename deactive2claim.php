	...
	<div class="table-responsive d-flex justify-content-center align-items-center">
	 <table class="table shadow table-responsive" id="ReportTable" style="width:100%;">
	  ...
	  <?php
	    ...
	    $seleq=mysql_query("SELECT e.*, c.ClaimName FROM `y".$_SESSION['FYearId']."_expenseclaims` e, claimtype c where e.ClaimYearId='".$_SESSION['FYearId']."' and c.ClaimId=e.ClaimId and e.FilledDate between '".$f."' and '".$t."' and e.ClaimStatus='Deactivate' order by e.BillDate ASC");
		$i=1;
